...
m7 = Movie.create(title: "Avengers: Endgame", description: "Adrift in space with no food or water, Tony Stark sends a message to Pepper Potts as his oxygen supply starts to dwindle. Meanwhile, the remaining Avengers -- Thor, Black Widow, Captain America and Bruce Banner -- must figure out a way to bring back their vanquished allies for an epic showdown with Thanos -- the evil demigod who decimated the planet and the universe.", img_url: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQZ1tJvdoKV1vgMM-XyYxpIqBIT5-SSSUOMKCw0oYhIRMi915xa", runtime: 182, director: "Russo Brothers", release_year: 2019, production_company: "Marvel Studios", box_office_earnings: 2_798)
...
", img_url: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRlob8acjb5LZnOYKDJrMsMZeRmaXu1qqF-kJym3A81hxgyjsWy", runtime: 152, director: "Christopher Nolan", release_year: 2008, production_company: "Warner Bros.", box_office_earnings: 1_006)
...
m17 = Movie.create(title: "GoodFellas", description: "Obsessed with bringing terrorist Castor Troy (Nicolas Cage) to justice, FBI agent Sean Archer (John Travolta) tracks down Troy, who has boarded a plane in Los Angeles. After the plane crashes and Troy is severely injured, possibly dead, Archer undergoes surgery to remove his face and replace it with Troy's. As Archer tries to use his disguise to elicit information about a bomb from Troy's brother, Troy awakes from a coma and forces the doctor who performed the surgery to give him Archer's face.", img_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgbD0iURYSqhv2P0SRr9WqR5RUSoVbj--7LSThBVHUC6kicCKl", runtime: 146, director: "Martin Scorsese", release_year: 1990, production_company: "Warner Bros.", box_office_earnings: 47)
